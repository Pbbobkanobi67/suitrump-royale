...
module suitrump_tokens::test_victory {
    ...
    public struct PublicFaucet has key {
        id: UID,
        treasury_cap: TreasuryCap<TEST_VICTORY>,
        faucet_amount: u64,  // Amount per claim (1,000 tokens)
    }
    ...
    fun init(witness: TEST_VICTORY, ctx: &mut TxContext) {
        ...
        let public_faucet = PublicFaucet {
            id: object::new(ctx),
            treasury_cap,
            faucet_amount: 1_000_000_000_000u64, // 1,000 tokens with 9 decimals
        };
    ...
    /// Mints 1,000 tokens (1,000 * 10^9 = 1 trillion smallest units)
